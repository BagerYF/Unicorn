...
public class CollectionQuery: GraphQLQuery {
  public static let operationName: String = "collection"
  ...
  public struct Data: AppSchema.SelectionSet {
    ...
    public struct Collection: AppSchema.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { AppSchema.Objects.Collection }
      public static var __selections: [ApolloAPI.Selection] { [
