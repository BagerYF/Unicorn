...
public class CheckoutShippingAddressUpdateV2Mutation: GraphQLMutation {
  public static let operationName: String = "checkoutShippingAddressUpdateV2"
  ...
  public struct Data: AppSchema.SelectionSet {
    ...
    public var checkoutShippingAddressUpdateV2: CheckoutShippingAddressUpdateV2? { __data["checkoutShippingAddressUpdateV2"] }

    /// CheckoutShippingAddressUpdateV2
    ///
    /// Parent Type: `CheckoutShippingAddressUpdateV2Payload`
    public struct CheckoutShippingAddressUpdateV2: AppSchema.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { AppSchema.Objects.CheckoutShippingAddressUpdateV2Payload }
      public static var __selections: [ApolloAPI.Selection] { [
