...
public class CheckoutDiscountCodeApplyV2Mutation: GraphQLMutation {
  public static let operationName: String = "checkoutDiscountCodeApplyV2"
  ...
  public struct Data: AppSchema.SelectionSet {
    ...
    public var checkoutDiscountCodeApplyV2: CheckoutDiscountCodeApplyV2? { __data["checkoutDiscountCodeApplyV2"] }

    /// CheckoutDiscountCodeApplyV2
    ///
    /// Parent Type: `CheckoutDiscountCodeApplyV2Payload`
    public struct CheckoutDiscountCodeApplyV2: AppSchema.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { AppSchema.Objects.CheckoutDiscountCodeApplyV2Payload }
      public static var __selections: [ApolloAPI.Selection] { [
