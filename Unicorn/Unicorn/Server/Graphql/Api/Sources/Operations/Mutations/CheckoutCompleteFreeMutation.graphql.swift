...
public class CheckoutCompleteFreeMutation: GraphQLMutation {
  public static let operationName: String = "checkoutCompleteFree"
  ...
  public struct Data: AppSchema.SelectionSet {
    ...
    public var checkoutCompleteFree: CheckoutCompleteFree? { __data["checkoutCompleteFree"] }

    /// CheckoutCompleteFree
    ///
    /// Parent Type: `CheckoutCompleteFreePayload`
    public struct CheckoutCompleteFree: AppSchema.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { AppSchema.Objects.CheckoutCompleteFreePayload }
      public static var __selections: [ApolloAPI.Selection] { [
