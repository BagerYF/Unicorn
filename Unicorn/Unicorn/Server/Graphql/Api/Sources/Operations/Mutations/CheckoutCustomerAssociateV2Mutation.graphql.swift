...
public class CheckoutCustomerAssociateV2Mutation: GraphQLMutation {
  public static let operationName: String = "checkoutCustomerAssociateV2"
  ...
  public struct Data: AppSchema.SelectionSet {
    ...
    public var checkoutCustomerAssociateV2: CheckoutCustomerAssociateV2? { __data["checkoutCustomerAssociateV2"] }

    /// CheckoutCustomerAssociateV2
    ///
    /// Parent Type: `CheckoutCustomerAssociateV2Payload`
    public struct CheckoutCustomerAssociateV2: AppSchema.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { AppSchema.Objects.CheckoutCustomerAssociateV2Payload }
      public static var __selections: [ApolloAPI.Selection] { [
