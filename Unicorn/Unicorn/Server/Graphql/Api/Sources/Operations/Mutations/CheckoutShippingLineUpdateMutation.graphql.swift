...
public class CheckoutShippingLineUpdateMutation: GraphQLMutation {
  public static let operationName: String = "checkoutShippingLineUpdate"
  ...
  public struct Data: AppSchema.SelectionSet {
    ...
    public var checkoutShippingLineUpdate: CheckoutShippingLineUpdate? { __data["checkoutShippingLineUpdate"] }

    /// CheckoutShippingLineUpdate
    ///
    /// Parent Type: `CheckoutShippingLineUpdatePayload`
    public struct CheckoutShippingLineUpdate: AppSchema.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { AppSchema.Objects.CheckoutShippingLineUpdatePayload }
      public static var __selections: [ApolloAPI.Selection] { [
